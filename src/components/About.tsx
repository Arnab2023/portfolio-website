      ...
      <div className="container flex  w-full max-sm:flex-col max-sm:mt-[40px] max-sm:mx-auto ">
        ...
        >
          ...
          <div className="contact-info flex mx-auto gap-[20px] mt-[30px]">
            <a
              href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&to=arnab192023@gmail.com"
              target="_blank"
            >
              <div className=" mail flex gap-2  border-white p-2 bg-gray-900 rounded-md hover:bg-gray-700 duration-500 cursor-pointer">
                ...
                <p className="text-white">arnab192023@gmail.com</p>
              </div>
            </a>
            <div className="phone flex gap-2 border-white p-2  bg-gray-900 rounded-md hover:bg-gray-700 duration-500 cursor-pointer">
              ...
              <p className="text-white">+91 9315953204</p>
            </div>
          </div>
        </motion.div>
      </div>
